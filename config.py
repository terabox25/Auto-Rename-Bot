...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', -1001984768732, '@LKD_Latest_Korean_Dramaa').split()] # give channel id with seperate space. Ex : ('-1001984768732')    
class Config(object):
    # pyro client config
